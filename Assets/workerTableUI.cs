...
public class WorkerTableUI : MonoBehaviour
{
    ...
    {
        // 예시용 작업자 목록
        workers.Add(new Worker { checkbox = true, name = "김철수", team = "홍보팀", position = "(100, 200)", worktime = "5:30", on_offline = true });
        //x: 100, y: 200
        //5시간 30분
        workers.Add(new Worker { checkbox = false, name = "안영희", team = "개발팀", position = "(0, 0)", worktime = "0:00", on_offline = false });
        workers.Add(new Worker { checkbox = false, name = "박수인", team = "개발팀", position = "(10, 50)", worktime = "1:00", on_offline = true });
        PopulateTable();
    }
